...
class TestBoard(unittest.TestCase):
    ...
    #     self.assertEqual(self.board.get_move_for_square(0, 0), [])
    #     self.assertEqual(self.board.get_move_for_square(1, 0), sorted([[0,2], [2,2]]))
    #     self.assertEqual(self.board.get_move_for_square(2, 0), sorted([]))
    #     self.assertEqual(self.board.get_move_for_square(3, 0), [])
    #     self.assertEqual(self.board.get_move_for_square(4, 0), [])
    #     self.assertEqual(self.board.get_move_for_square(0, 1), sorted([0,2]))
    #     self.board.play_a_move((1,0), (4,5))
    #     self.assertEqual(self.board.get_move_for_square(4, 5), sorted([[3,7], [5,7], [2,6], [6,6], [6,4], [2,4], [3,3], [5,3]]))
    #     self.board.play_a_move((0,0), (3,5))
    #     self.assertEqual(self.board.get_move_for_square(3, 5), sorted([[2,5], [1,5], [0,5], [3,4], [3,3], [3,2], [3,6]]))
    ...
    #     self.assertEqual(self.board.get_move_for_square(5, 2), sorted([[4,1], [6,1], [6,3], [7,4], [4,3], [3,4], [2,5]]))
    #     self.board.play_a_move((3,0), (7,5))
        
    #     self.assertEqual(self.board.get_move_for_square(5, 2), sorted([[7,6], [6,6], [6,5], [5,5], [7,4], [7,3], [7,2], [7,1], [6,4], [5,3], [4,2]]))
        
    #     self.board.play_a_move((4,7), (2,3))
